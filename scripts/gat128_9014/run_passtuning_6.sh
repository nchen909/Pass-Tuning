...
for model in "${model_lst[@]}"; do
    ...
    #NLU
    CUDA_VISIBLE_DEVICES=6 bash run_gat128.sh $model clone
    ...
    # CUDA_VISIBLE_DEVICES=2 bash run_gat128.sh $model summarize ruby
    # CUDA_VISIBLE_DEVICES=3 bash run_gat128.sh $model summarize javascript
    # CUDA_VISIBLE_DEVICES=2 bash run_gat128.sh $model summarize go
    # CUDA_VISIBLE_DEVICES=5 bash run_gat128.sh $model summarize python
    # CUDA_VISIBLE_DEVICES=3 bash run_gat128.sh $model summarize java
    # CUDA_VISIBLE_DEVICES=4 bash run_gat128.sh $model summarize php
