...
for model in "${model_lst[@]}"; do
    ...
    #NLU
    CUDA_VISIBLE_DEVICES=6 bash run_pass_tuning.sh $model clone
    ...
    # CUDA_VISIBLE_DEVICES=5 bash run_pass_tuning.sh $model summarize python
    # CUDA_VISIBLE_DEVICES=3 bash run_pass_tuning.sh $model summarize java
    # CUDA_VISIBLE_DEVICES=4 bash run_pass_tuning.sh $model summarize php
