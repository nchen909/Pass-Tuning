...
for model in "${model_lst[@]}"; do
    ...
    # CUDA_VISIBLE_DEVICES=1 bash run_pass_tuning.sh $model summarize ruby
    # CUDA_VISIBLE_DEVICES=1 bash run_pass_tuning.sh $model summarize javascript
    # CUDA_VISIBLE_DEVICES=1 bash run_pass_tuning.sh $model summarize go
    # CUDA_VISIBLE_DEVICES=1 bash run_pass_tuning.sh $model summarize python
    # CUDA_VISIBLE_DEVICES=1 bash run_pass_tuning.sh $model summarize java
