...
for model in "${model_lst[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=3 bash run_prefix.sh $model defect
    CUDA_VISIBLE_DEVICES=3 bash run_prefix.sh $model translate java-cs
    CUDA_VISIBLE_DEVICES=3 bash run_prefix.sh $model translate cs-java
    CUDA_VISIBLE_DEVICES=3 bash run_prefix.sh $model clone
