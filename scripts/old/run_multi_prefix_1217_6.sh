...
for model in "${model_lst[@]}"; do
    ...
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize ruby
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize javascript
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize go
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize python
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize java
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model summarize php
    CUDA_VISIBLE_DEVICES=5 bash run_prefix.sh $model refine small
