...
class E2D_Model_Prefix(PushToHubFriendlyModel):
    def __init__(self, args):
        ...
        self.code_prefix_tokens = torch.tensor(self.code_prefix_tokens, dtype=torch.long).cuda()#shape:batch_size,preseqlen
        self.code_prefix_matrix = torch.tensor(self.code_prefix_matrix, dtype=torch.long).cuda()#shape:batch_size,preseqlen,preseqlen
