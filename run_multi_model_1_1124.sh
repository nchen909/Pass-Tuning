...
for model in "${model_lst[@]}"; do
    ...
    # #NLG
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model translate java-cs
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model translate cs-java
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model refine small
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model refine medium
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model generate

    
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize ruby
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize javascript
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize go
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize python
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize java
    # CUDA_VISIBLE_DEVICES=0 bash run.sh $model summarize php
