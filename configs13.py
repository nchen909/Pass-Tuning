...
def set_hyperparas(args):
    if args.task == 'summarize':
        ...
        args.num_train_epochs = 15 if args.few_shot == -1 else 4 #10 *1.5
        args.patience = 2 if args.few_shot == -1 else 0
        args.weight_decay = 0.0
        args.warmup_steps = 1000

        if args.model_name in ['roberta', 'codebert', 'graphcodebert','unixcoder']:
            args.batch_size = 48 if args.few_shot == -1 else 4 #32*1.5
        elif args.model_name in ['t5', 'codet5']:
            args.batch_size = 32 if args.few_shot == -1 else 4
        elif args.model_name in ['bart', 'plbart']:
            args.batch_size = 48 if args.few_shot == -1 else 4
        ...
        args.num_train_epochs = 15 if args.few_shot == -1 else 6
        args.patience = 2 if args.few_shot == -1 else 0
        args.weight_decay = 0.0
        args.warmup_steps = 1000
        ...
        args.num_train_epochs = 30 if args.few_shot == -1 else 12
        ...
        args.max_source_length = 256
        args.max_target_length = 256
        args.num_train_epochs = 10 if args.few_shot == -1 else 4
        args.patience = 2 if args.few_shot == -1 else 0
        args.weight_decay = 0.0
        args.warmup_steps = 1000
        ...
        args.num_train_epochs = 5 if args.few_shot == -1 else 2
        args.patience = 2 if args.few_shot == -1 else 0
        args.weight_decay = 0.0
        args.warmup_steps = 1000
